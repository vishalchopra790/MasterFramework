package com.company.driver.manager.mobile.remote.saucelabs;

import org.openqa.selenium.WebDriver;
import org.openqa.selenium.remote.DesiredCapabilities;
import org.openqa.selenium.remote.RemoteWebDriver;

import static com.company.config.factory.SauceLabsConfigFactory.getConfig;
...
public class SauceLabsAndroidManager {
    ...
    public static WebDriver getDriver(){
        ...
        return new RemoteWebDriver(getConfig().sauceLabsURL(), capabilities);
    }
}
